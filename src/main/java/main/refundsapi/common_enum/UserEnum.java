...
public enum UserEnum {
    ...
    /*
     * 200011 : 회원 정보가 정상적으로 등록 되지 않았습니다. (필수 요청값을 확인해 주세요.)
     */
    USER_SAVE_FAIL("400010", "회원 정보가 정상적으로 등록 되지 않았습니다. (필수 요청값을 확인해 주세요.)"),
     ...
     */
    USER_SAVE_ACCESS("400044", "회원 가입이 불가능한 정보 입니다."),
    ...
    /*
     * 200030 : 회원 정보가 정상적으로 조회 되었습니다.
     */
    USER_FIND_SUCESS("200030", "회원 정보가 정상적으로 조회 되었습니다.");
